...
(
    ...
    PRIMARY KEY (`id`),
    KEY `program_user_index` (`user_id`)
) ENGINE = MyISAM
  AUTO_INCREMENT = 2
...
VALUES (1, 1, '2019-06-29 10:12:31', '2019-06-29 10:12:58', _binary '', '2019-07-31', _binary '\0', 70.1, 'COMFORT',
        72.1, 1);
/*!40000 ALTER TABLE `programs`
    ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-06-29 13:14:21
